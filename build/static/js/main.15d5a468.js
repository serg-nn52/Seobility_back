/*! For license information please see main.15d5a468.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        function Oo(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Uo(9, Fo.bind(null, n, r, l, t), void 0, null),
              null === zi)
            )
              throw Error(a(349));
            0 !== (30 & ho) || Ro(n, t, l);
        ...
        function qu(e, t, n) {
          ...
          switch ((ta(t), t.tag)) {
            ...
            case 4:
              return (
                lo(), null === e && $r(t.stateNode.containerInfo), Qu(t), null
              );
            case 10:
        ...
        function cs(e) {
          ...
          try {
            ...
            (bt = r), (Pi.transition = n), 0 === (6 & (Ni = t)) && $l();
          }
        }
        function fs() {
          (Oi = Ri.current), _l(Ri);
        ...
        function vs(e, t) {
          ...
          if ((ka(), (Ni = n), (_i.current = r), null !== Li))
            throw Error(a(261));
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 === (32768 & t.flags))) {
              if (null !== (n = qu(n, t, Oi))) return void (Li = n);
            } else {
              if (null !== (n = Ku(n, t)))
        ...
        function Bs(e, t, n, r, l, a, o, u, i) {
          return (
            ((e = As(n, r, !0, e, 0, a, 0, u, i)).context = $s(null)),
            (n = e.current),
            ((a = Ra((r = es()), (l = ts(n)))).callback =
  ...
  (n.p = "/"),
    (function () {
      ...
      var s = n.p + "static/media/loader.2187296e5d399b5c8373.gif",
        c = "style_preloader__6o-81",
        f = n(184),
        d = function () {
          return (0, f.jsx)("div", {
            className: c,
            children: (0, f.jsx)("img", { src: s, alt: "Loading..." }),
          });
        },
        p = (function () {
          var e = o(
      ...
      var b = "style_input__kypOB",
        w = "style_error__JHf-9",
        k = "style_hide__Ku0qf",
        S = function (t) {
          var n = t.name,
            r = t.label,
          ...
          var c = function (e) {
            switch ((" " === o[e] && (o[e] = ""), e)) {
              case "name":
                return (
                  ...
                  o[e].split(" ").forEach(function (e) {
                    ((e.length < 3 && e.length > 0) || e.length > 30) &&
                      (s = !0);
                  }),
                  o[e].toUpperCase()
                );
              case "email":
                return (
                  /^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i.test(o[e]) ||
                    "" === o[e] ||
                    " " === o[e] ||
                    (s = !0),
                  o[e]
              ...
              case "phoneNumber":
                return (
                  /^((\+7))\d{10,10}$/.test(o[e]) || "" === o[e] || (s = !0),
                  "+" !== o[e][0]
                    ? ""
                    : o[e].length > 1 && !/^\+?[0-9]+$/.test(o[e].slice(-1))
                    ? o[e].slice(0, -1)
                    : o[e]
                );
              case "message":
                return (
                  (o[e].length < 10 || o[e].length > 300) &&
                    "" !== o[e] &&
                    (s = !0),
                  o[e]
                );
          ...
          return (0, f.jsxs)("div", {
            className: b,
            children: [
              (0, f.jsx)("label", { htmlFor: n, children: r }),
              "message" === n
                ? (0, f.jsx)("textarea", {
                    id: n,
                    value: c(n),
                    ...
                    maxLength: 300,
                    name: n,
                    style: { border: s ? "1px solid red" : "" },
                    onChange: function (e) {
                      return a(y(y({}, o), {}, v({}, n, e.target.value)));
                    },
                  })
                : (0, f.jsx)("input", {
                    type: "text",
        ...
        x = function () {
          var t = {
            ...
            w = (0, e.useRef)(null);
          b.style.overflow = "pending" === g ? "hidden" : "";
          var k = (function () {
            var e = o(
              l().mark(function e(n) {
                var o, u, i;
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (n.preventDefault(),
                          (o = Object.values(s).includes(!0)),
                          (u = Object.values(r).includes("")),
                          o || u)
                        ) {
                          e.next = 13;
                          break;
                        ...
                        return (
                          ...
                          (w.current.innerHTML = ""),
                          (e.next = 8),
                          p("https://seobility.herokuapp.com/api/user", r)
                        );
                      case 8:
                        (i = e.sent).succes && (a(t), y("fullfild")),
                          !i.succes && i && y("rejected"),
                          (e.next = 14);
                        break;
                      case 13:
                        w.current.innerHTML =
                ...
                children: [
                  ...
                  (0, f.jsx)(S, {
                    ...
                    label:
                      "\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435",
                    placeholder:
                      "\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435, \u0434\u043b\u0438\u043d\u0430 \u043e\u0442 10 \u0434\u043e 300 \u0441\u0438\u043c\u0432\u043e\u043b\u043e\u0432",
                    user: r,
                    setUser: a,
                    errors: s,
                    setErrors: c,
                  }),
                  (0, f.jsx)("div", { className: m, ref: w }),
                  (0, f.jsx)("button", {
                    type: "submit",
                    onClick: function (e) {
                      return k(e);
      ...
      t.createRoot(document.getElementById("root")).render(
        (0, f.jsx)(e.StrictMode, { children: (0, f.jsx)(_, {}) })
      );
    })();
})();
//# sourceMappingURL=main.15d5a468.js.map
